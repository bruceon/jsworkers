...
jsworkers.map(...).𝑚𝑎𝑝(...).𝑠𝑒𝑡𝑂𝑝𝑡𝑖𝑜𝑛𝑠({𝑝𝑟𝑜𝑐𝑒𝑠𝑠𝑃𝑟𝑒𝑓𝑒𝑟𝑟𝑒𝑑: 𝑡𝑟𝑢𝑒}, 𝒕𝒓𝒖𝒆).𝑟𝑒𝑑𝑢𝑐𝑒(...)
</pre>
...
line (\*\*) finally produces ![\sum_{i=1}^{n}\[fib(i)\]^{2}](https://latex.codecogs.com/svg.latex?%5Csum_%7Bi%3D1%7D%5E%7Bn%7D%5C%5Bfib(i)%5C%5D%5E%7B2%7D) <br/>
