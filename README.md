...
line (\*\*) finally produces ![\sum_{i=1}^{n}\[fib(i)\]^{2}](https://latex.codecogs.com/svg.latex?\sum_{i=1}^{n}\[fib(i)\]^{2}) <br/><br/>
line (\*\*\*) finally produces ![\sum_{i=1}^{n}\[fib(i)\]^{0.5}](https://latex.codecogs.com/svg.latex?\sum_{i=1}^{n}\[fib(i)\]^{0.5}) <br/>
